...
function signupAction(prevFormState, formData) {
  ...
  if (!isNotEmpty(password) || !hasMinLength(password, 5)) {
    errors.push("You must provide a password with at least five characters");
  }
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked={formState.values?.acquisitionChannel.includes(
              "google"
            )}
          />
